export type SocialIconName = "whatsapp" | "email" | "linkedin" | "x";

/**
 * Brand glyphs, inlined rather than loaded from an icon CDN — the site ships
 * no external assets. All are single-path/solid on a 24x24 grid and use
 * `currentColor`, so they inherit hover and theme colours like text does.
 */
const PATHS: Record<SocialIconName, string[]> = {
  whatsapp: [
    ...
    "M20.52 3.449A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.423-8.452ZM12.05 21.785h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884Z",
  ],
  email: [
  ...
  x: [
    "M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.933Zm-1.291 19.482h2.039L6.486 3.24H4.298l13.312 17.395Z",
  ],
};
